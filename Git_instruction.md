...
Создаю комит в ветке **master**

     После коммита данной строки, перейду работать на новую ветку expirement.
     
Начинаю домашнюю работу 

*Добавляю новое описание курсивом*
...
Я перешла на ветку __*expirement*__

 Эту ветку я объединю с веткой __*homeword*__
     
Создаю последний коммит, после чего объединяю данную ветку __*homeword*__ с __*master*__

На данном этапе я завершаю свою домашнюю работу! 
Спасибо за внимание ;) !
