...
Он позволяет добавить файлу изменение и сразу его закоммитить (но лучше не надо)
...
Если мы хотим помочь какому-то проекту на GitHub и предложить наши улучшения, нужно его скопировать в свой репозиторий на GitHub, внести изменения в отдельной ветке и предложить их автору на GitHub (pull request)

1. В GitHub на странице проекта скопировать его (fork) в новый репозиторий на своем аккаунте (создастся автоматически)
2. Скопировать ссылку (code - скопировать линк)
3. Создать у себя отдельную папку, открыть в VSC
4. Склонировать в папку скопированный репозиторий по ссылке

        git clone <ссылка>
5. Перейти в папку скопированного репозитория 
   
        cd <имя репозитория>
6. Создать новую ветку, перейти в нее

        git branch <название новой ветки>
        git checkout <название новой ветки>
7. Внести изменения, сохранить, закоммитить
8. Загрузить в репозиторий на GitHub 

        git push

9. На GitHub в репозитории выбрать ветку с нашими изменениями - Contribute - Open Pull Request
10. Добавить комментарии и Create Pull Request
