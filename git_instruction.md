...
После того как данные были направлены из локального репо в удаленный в твоем профиле на Git Hub, сравни и отправь запрос на внесение изменений в проект по средствам команды:
