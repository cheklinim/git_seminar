...
Чтобы направить изменение в удаленный депозиторий необходимо в терминале ввезди команду:

    git push

Чтобы выгрузить изменения из удаленного депозитория необходимо в терминале ввезди команду:
